...
const LastWord = (str) => {
    ...
    let modifiedStr = str.slice(str.lastIndexOf(" ") + 1);
    return modifiedStr;
}
// -------------------------------------------------------------------------------------------------------
...
const LastWord_2 = (str) => {
    // write your code here
    let modifiedArr = str.split(" ");
    return modifiedArr[modifiedArr.length - 1];
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    ...
    inArray.forEach(element => {
        if (inObject.hasOwnProperty(element)) {
            let index = inArray.lastIndexOf(element);
            inArray.splice( index , 1 , inObject[element]);
        }
    });
