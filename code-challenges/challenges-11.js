...
function square(arr) {
    ...
    let squareArr = arr.map(arrItem => {
        return Math.pow(arrItem, 2);
    })
    return squareArr;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    ...
    let objArr = arr.map(modifiedArr => {
        return `${modifiedArr.firstName} ${modifiedArr.lastName}`
    })
    return objArr;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
     let newArr = arr.map((elem) => ({ 
        ...elem, avg: elem.gradsList.reduce((sum, grade) => sum + grade) / elem.gradsList.length 
    })); 
    return newArr;
 }
// -------------------------------------------------------------------------------------------------------
